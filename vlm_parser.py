...
PROMPT = """Ты распознаёшь фото меню столовой. Верни ТОЛЬКО JSON, без пояснений и без ```.
...
- name — название блюда точно как на фото, без номера в списке и без описания состава в скобках.
